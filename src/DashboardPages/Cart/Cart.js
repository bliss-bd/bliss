      ...
      <div className="flex-1">
          ...
          >
            <div className="lg:px-2 lg:w-1/2">
              ...
              <div className="bg-white shadow-md rounded px-8 pt-6 pb-6 flex flex-col mt-2">
                <div className="-mx-3 md:flex mb-6">
                  <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                    <label className="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="grid-first-name">
                      Full Name*
                    </label>
                    <input className="appearance-none block w-full bg-gray-600 text-white border border-red rounded py-3 px-4 mb-3" id="grid-first-name" type="text"
                      name="name"
                  ...
                  <div className="md:w-1/2 px-3">
                    ...
                    <input className="appearance-none block w-full bg-gray-600 text-white border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-last-name"
                      name="phone"
                ...
                <div className="-mx-3 md:flex mb-6">
                  <div className="md:w-full px-3">
                    ...
                    <input className="appearance-none block w-full bg-gray-600 text-white border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-password" name="email"
                      required
                ...
                <div className="-mx-3 md:flex mb-6">
                  <div className="md:w-full px-3">
                    ...
                    <select className="block appearance-none w-full border border-grey-lighter bg-gray-600 text-white py-3 px-4 pr-8 rounded" id="grid-state" value={district}
                ...
                <div className="-mx-3 md:flex mb-6">
                  <div className="md:w-full px-3">
                    ...
                    <input className="appearance-none block w-full bg-gray-600 text-white border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-password" name="address"
                ...
                <div className="-mx-3 md:flex mb-6">
                  <div className="md:w-full px-3">
                    ...
                    <textarea className=" h-24 appearance-none block w-full bg-gray-600 text-white border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-password" name="note"
