          ...
          <form id="billingForm" onSubmit={handlePlaceOrder} className="my-4 mt-6 -mx-2 lg:flex">
            ...
            <div className="lg:px-2 lg:w-1/2">
              ...
              <div className="p-4">
                ...
                <button type='submit' className="flex justify-center w-full px-10 py-3 mt-6 font-medium  uppercase rounded-full shadow item-center  bg-[#8af104] hover:bg-black hover:text-[#8af104] border-black border-2 focus:shadow-outline focus:outline-none">
