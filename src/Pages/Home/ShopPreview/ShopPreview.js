...
const ShopPreview = () => {
  return (
    <div>
      <div className="relative flex flex-col-reverse  lg:py-20 lg:flex-col py-16  bg-slate-50">
        ...
        <div className="inset-y-0 top-0 right-0 w-full max-w-xl px-4 mx-auto mb-6 md:px-0 lg:pl-8 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-1/2 lg:max-w-full lg:absolute xl:px-0">
          <img
            className="object-cover w-full p-32 rounded-md h-56  shadow-lg lg:rounded-none lg:shadow-none md:h-96 lg:h-full"
