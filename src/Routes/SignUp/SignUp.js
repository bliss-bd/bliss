...
import "./Form.css";
import lay from "../../assets/layered-steps-haikei.svg";
    ...
    <div>
      <div class="relative min-h-screen flex ">
        <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
          <div class="sm:w-1/2 xl:w-2/5 h-full hidden md:flex flex-auto items-center justify-start p-10 overflow-hidden bg-gray-900 text-white bg-no-repeat bg-cover relative">
            <div class="absolute bg-gradient-to-b to-lime-300  from-gray-900 opacity-75 inset-0 z-0"></div>
            <div class="absolute min-h-screen right-0">
              <img src={wave} className="w-full h-screen"></img>
            </div>
            <div class="w-full ml-24 max-w-md z-10">
